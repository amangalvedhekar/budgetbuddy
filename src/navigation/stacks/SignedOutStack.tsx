...
import {ForgotPassword} from "../../screens/signedout/ForgotPassword";
...
export const SignedOutScreens = () => {
  return (
    <SignedOutStack.Navigator screenOptions={{headerLeftLabelVisible: false}}>
      ...
      <SignedOutStack.Screen name="ForgotPassword" component={ForgotPassword} options={{headerTitle:'Reset Password'}} />
